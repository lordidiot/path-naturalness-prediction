...
gpu = False
def evaluate(d, fea_len, encoder_path, predictor_path, soft_label=False):
...
def main():
	...
	if encoder_path == "all" and predictor_path == "all":
		with open("./test.log", "w") as f:
			...
			while epoc < 4000:
				...
				acc = evaluate(dataset, feature_len, encoder_path, predictor_path, soft_label=False)
				f.write(f'{acc}\n')
				epoc += 50
	...
	print(evaluate(dataset, feature_len, encoder_path, predictor_path, soft_label=False))
